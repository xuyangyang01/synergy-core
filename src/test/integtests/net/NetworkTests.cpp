...
public:
    NetworkTests () : m_mockData (nullptr) {
    ...
    void sendToClient_mockData_handleClientConnected (const Event& /*unused*/,
                                                      void* vlistener);
    void sendToClient_mockData_fileRecieveCompleted (const Event& /*event*/,
                                                     void* /*unused*/);

    void sendToClient_mockFile_handleClientConnected (const Event& /*unused*/,
                                                      void* vlistener);
    void sendToClient_mockFile_fileRecieveCompleted (const Event& event,
                                                     void* /*unused*/);

    void sendToServer_mockData_handleClientConnected (const Event& /*unused*/,
                                                      void* vclient);
    void sendToServer_mockData_fileRecieveCompleted (const Event& event,
                                                     void* /*unused*/);

    void sendToServer_mockFile_handleClientConnected (const Event& /*unused*/,
                                                      void* vclient);
    void sendToServer_mockFile_fileRecieveCompleted (const Event& event,
                                                     void* /*unused*/);
...
void
NetworkTests::sendToClient_mockData_handleClientConnected (
    const Event& /*unused*/, void* vlistener) {
...
void
NetworkTests::sendToServer_mockData_handleClientConnected (
    const Event& /*unused*/, void* vclient) {
